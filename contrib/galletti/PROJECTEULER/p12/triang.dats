...
where
{
  ...
  val div50 = stream_filter(tris, lam(t) => $effmask_all(div_check(t)))
  val-stream_cons(d, div50) = !div50
  val () = println!("Frist Triangular Number with more than 50 divisors is ", d)
}
