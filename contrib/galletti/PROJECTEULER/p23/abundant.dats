...
where
{
  val ns = list0_reverse(nats(5000))
  ...
  val () = println!("The sum of all integers < 5000 that can be expressed as the sum of 2 abundant numbers is ", list0_foldleft<int>(xs, 0, lam(res, x) => x + res))
}
