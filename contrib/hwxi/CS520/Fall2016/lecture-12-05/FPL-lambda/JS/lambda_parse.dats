...
(* ****** ****** *)
//
typedef decl = $tup(tvar, term)
//
val
par_decl =
parser_join2
  {token}{tvar,term}
  (par_var, par_EQ >> par_term0)
//
(* ****** ****** *)
//
fun
...
par_TMlet =
parser_map2
  {token}{decl,term}{term}
(
  par_LET >> par_decl
, par_IN >> (par_term0 << par_END)
, lam(d, t) => TMlet(d, t)
)
